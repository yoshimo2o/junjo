...
declare -A GROUPING_DESCRIPTIONS=(
  ["$GROUP_BY_DEVICE"]="Group by device: e.g. iPhone 13, Android, Desktop, etc. (if detected)"
  ["$GROUP_BY_SOFTWARE"]="Group by software: e.g. WhatsApp, Facebook, etc. (if detected)"
  ["$GROUP_BY_YEAR"]="Group by year: e.g. 2025, 2024, etc."
  ["$GROUP_BY_MONTH"]="Group by month: e.g. 08, 09, 10, 11, etc."
  ["$GROUP_BY_DAY"]="Group by day: e.g. 28, 29, 30, etc."
  ["$GROUP_BY_YEAR_MONTH"]="Group by YYYY-MM: e.g. 2025-11, 2017-18, etc."
  ["$GROUP_BY_YEAR_MONTH_DAY"]="Group by YYYY-MM-DD: e.g. 2025-11-30, 2017-08-02, etc."
  ["$GROUP_BY_DUPLICATES"]="Group by duplicates: e.g. Duplicates of IMG_3118.JPG, etc."
