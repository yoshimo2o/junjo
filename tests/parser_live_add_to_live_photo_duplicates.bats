...
# Test file for add_to_live_photo_duplicates function
...
# ====================================================================================================
# Tests for add_to_live_photo_duplicates function
# ====================================================================================================

@test "add_to_live_photo_duplicates: adds first duplicate for CID" {
  # Setup - simulate first photo already found
  live_photo_by_cid["cid123"]="fid1"

  # Run the function - add first duplicate
  add_to_live_photo_duplicates "cid123" "fid2"
...
@test "add_to_live_photo_duplicates: adds second duplicate for CID" {
  # Setup - simulate first photo and one duplicate already found
  live_photo_by_cid["cid123"]="fid1"
  live_photo_duplicates["cid123"]="fid2"
  file_has_duplicates["fid1"]=1
  file_has_duplicates["fid2"]=1
  file_is_preferred_duplicate["fid1"]=1

  # Run the function - add second duplicate
  add_to_live_photo_duplicates "cid123" "fid3"

  # Verify duplicate is appended with pipe separator
  [ "${live_photo_duplicates[cid123]}" = "fid2|fid3" ]
...
@test "add_to_live_photo_duplicates: adds multiple duplicates sequentially" {
  # Setup - simulate first photo already found
  live_photo_by_cid["cid123"]="fid1"
  ...
  # Add third duplicate
  add_to_live_photo_duplicates "cid123" "fid4"

  # Verify all duplicates are tracked (includes original + all duplicates)
  [ "${live_photo_duplicates[cid123]}" = "fid1|fid2|fid3|fid4" ]
...
@test "add_to_live_photo_duplicates: handles different CIDs independently" {
  # Setup - simulate photos for different CIDs
  live_photo_by_cid["cid123"]="fid1"
  live_photo_by_cid["cid456"]="fid3"

  # Add duplicates for different CIDs
  add_to_live_photo_duplicates "cid123" "fid2"
  add_to_live_photo_duplicates "cid456" "fid4"
...
@test "add_to_live_photo_duplicates: requires existing primary photo" {
  # This test verifies the function works correctly when primary photo exists
  # Setup - simulate first photo already found
  live_photo_by_cid["cid123"]="fid1"
